  ...
  return (
    <>
      <nav aria-label="Worlds" className="rail" data-ui>
        <Link href="/" className="rail-home" aria-label="Orrery home" aria-current={location === '/' ? 'page' : undefined} data-tip="Orrery">
        ...
        <div className="rail-foot">
          <ShareMenu />
          <button className="rail-link" onClick={() => setSources(true)} data-testid="sources-button" aria-label="Sources and credits" data-tip="Sources">
            <Glyph.sources />
          </button>
          <SettingsButton />
          <a href="https://github.com/ethan-goldstein/orrery" target="_blank" rel="noopener noreferrer" className="rail-link" aria-label="Source code on GitHub" data-tip="GitHub">
            <Glyph.github />
          </a>
        </div>
      </nav>
